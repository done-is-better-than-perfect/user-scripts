...
var Styles = (function () {
  ...
  return {
    ...
    _css: function () {
      ...
      '  width: 24px !important; height: 24px !important; color: rgba(0,0,0,0.55) !important;',
      '}',
      ...
      '.us-df-dialog-message .us-df-dialog-intro { margin-bottom: 12px !important; }',
      ...
      '  display: grid !important; grid-template-columns: 24px 52px 24px !important; grid-template-rows: 24px 36px 24px !important;',
      '  gap: 3px !important; justify-items: center !important; align-items: center !important;',
      '  margin: 2px auto 10px !important; width: max-content !important;',
      '}',
...
var Tab = (function () {
  ...
  create: function () {
    ...
    iconWrap.addEventListener('click', function () {
        ColorPopover.hide();
        if (window.Panel && window.Panel.open) window.Panel.open();
      });
...
var ColorCustomizerFeature = (function () {
  ...
  window.StyleApplier = StyleApplier;
  window.Styles = Styles;
  window.EditMode = EditMode;
  window.ColorPopover = ColorPopover;
  window.ChipColorPopover = ChipColorPopover;
